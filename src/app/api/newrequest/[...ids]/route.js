...
// key, requestId, requestType, collegeId, description, requestFrom, requestTo, duration, isAllowed
    ...
    try{
        ...
        if(await Keyverify(params.ids[0])){
            ...
            try {
                ...
                // create new request
                const [rows, fields] = await connection.execute(q, [ params.ids[1], params.ids[2], params.ids[3], params.ids[4], params.ids[5], params.ids[6], params.ids[7], "Submitted", currentDate ,  '-','-', null, '-', '-','-',null, 1, 0, null, params.ids[8]]);
                connection.release();
